...
namespace XF.sBaseMethod
{
    public class XFSQLDrive
    {
        //定义一个连接字符串
        //readonly修饰的变量，只能在初始化的时候赋值，以及在构造函数中赋值       
        private static readonly string conStr = ConfigurationManager.ConnectionStrings["ConnectString"].ConnectionString;
        ...
        public static int GetMinID(string FieldName, string TableName)
        {
            ...
            object obj = XFSQLDrive.GetSingle(strsql);
            if (obj == null)
            {
                return 0;
            }
        ...
        {
            object obj = XFSQLDrive.GetSingle(strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        public static int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList)
        {
            using (SqlConnection conn = new SqlConnection(conStr))
            {
                ...
                try
                {
                    ...
                    //string oraconStr = PubConstant.GetconStr("conStrPPC");
                    //bool res = OracleHelper.ExecuteSqlTran(oraconStr, oracleCmdSqlList);
                    //if (!res)
                    //{
                    //    tx.Rollback();
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet HISQuery(string SQLString)
        {
